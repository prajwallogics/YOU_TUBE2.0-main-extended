import { Bell, Crown, Menu, Mic, Moon, Search, Sun, User, VideoIcon } from "lucide-react";
...
const Header = () => {
  const { user, logout, handlegooglesignin, isSigningIn, theme, updateThemePreference } = useUser();
  // const user: any = {
  //   id: "1",
  //   name: "John Doe",
